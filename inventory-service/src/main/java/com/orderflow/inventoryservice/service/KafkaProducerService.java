...
public class KafkaProducerService {
    ...
    public void sendInventoryEvent(InventoryEvent event) {
        log.info("Publishing inventory event: type={}, orderId={}", event.getEventType(), event.getOrderId());
        kafkaTemplate.send(KafkaConstants.INVENTORY_EVENTS_TOPIC, String.valueOf(event.getOrderId()), event);
    }
}
